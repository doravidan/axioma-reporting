...
- [ ] **Page title in Hebrew** — Browser tab shows "à÷ñéåîà" or similar
...
- [ ] **"ùìç îééì áãé÷ä"** ? success message shown
...
- [ ] `/Admin/ReportingMonths` — **exactly one** month is active (`ôòéì = ëï`), correct year/month for current period
...
- [ ] **Rule 7** — Pick employee's rest day ? block: "àéï ìãååç òì éåí îðåçä"
...
- [ ] **Activity-based terminology** — UI text uses "ôòéìåú çåãùéú" / "îùê úôå÷ä", **NOT** "ùòåú" anywhere in employee-facing screens (rule #14)
...
- [ ] **3 wrong logins** ? account locked ? Hebrew "çùáåï ðòåì" message
