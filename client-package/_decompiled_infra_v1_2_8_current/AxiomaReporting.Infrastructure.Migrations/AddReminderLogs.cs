...
[Migration("20260412134615_AddReminderLogs")]
public class AddReminderLogs : Migration
{
	protected override void Up(MigrationBuilder migrationBuilder)
	{
		migrationBuilder.CreateTable("ReminderLogs", delegate(ColumnsBuilder table)
		{
			...
			return new
			{
				...
				TemplateType = table.Column<string>("nvarchar(100)", null, maxLength),
				SentAt = table.Column<DateTime>("datetime2")
			};
		}, null, table =>
		{
			table.PrimaryKey("PK_ReminderLogs", x => x.Id);
			table.ForeignKey("FK_ReminderLogs_ReportingMonths_ReportingMonthId", x => x.ReportingMonthId, "ReportingMonths", "Id", null, ReferentialAction.NoAction, ReferentialAction.Cascade);
			table.ForeignKey("FK_ReminderLogs_Users_UserId", x => x.UserId, "Users", "Id", null, ReferentialAction.NoAction, ReferentialAction.Cascade);
		});
		migrationBuilder.CreateIndex("IX_ReminderLogs_ReportingMonthId", "ReminderLogs", "ReportingMonthId");
		migrationBuilder.CreateIndex("IX_ReminderLogs_UserId_ReportingMonthId_TemplateType_SentAt", "ReminderLogs", new string[4] { "UserId", "ReportingMonthId", "TemplateType", "SentAt" });
	}

	protected override void Down(MigrationBuilder migrationBuilder)
	{
		migrationBuilder.DropTable("ReminderLogs");
	}
