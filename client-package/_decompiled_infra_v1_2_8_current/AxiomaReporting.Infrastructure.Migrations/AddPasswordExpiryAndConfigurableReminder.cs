...
[Migration("20260412170550_AddPasswordExpiryAndConfigurableReminder")]
public class AddPasswordExpiryAndConfigurableReminder : Migration
{
	protected override void Up(MigrationBuilder migrationBuilder)
	{
		migrationBuilder.DropForeignKey("FK_ReminderLogs_ReportingMonths_ReportingMonthId", "ReminderLogs");
		Type typeFromHandle = typeof(int);
		migrationBuilder.AlterColumn<int>("ReportingMonthId", "ReminderLogs", "int", null, null, rowVersion: false, null, nullable: true, null, null, null, typeFromHandle, "int");
		migrationBuilder.InsertData("EmailTemplates", new string[7] { "Id", "Body", "CreatedAt", "IsActive", "Subject", "TypeDescription", "UpdatedAt" }, new object[7]
		{
			8,
			...
			true,
			"התראה: סיסמתך עומדת לפוג",
			"PasswordExpiryWarning",
			null
		});
		migrationBuilder.InsertData("SystemConstants", new string[7] { "Id", "CreatedAt", "Description", "Key", "UpdatedAt", "UpdatedBy", "Value" }, new object[2, 7]
		{
			{
				7,
				new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
				"כמה שעות בין כל ריצה של שירות התזכורות",
				"ReminderCheckIntervalHours",
				null,
				null,
				"1"
			},
			{
				8,
				new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
				"כמה ימים לפני פקיעת הסיסמה לשלוח אזהרה למשתמש",
		...
		migrationBuilder.AddForeignKey("FK_ReminderLogs_ReportingMonths_ReportingMonthId", "ReminderLogs", "ReportingMonthId", "ReportingMonths", null, null, "Id", ReferentialAction.NoAction, ReferentialAction.SetNull);
	}

	protected override void Down(MigrationBuilder migrationBuilder)
	{
		migrationBuilder.DropForeignKey("FK_ReminderLogs_ReportingMonths_ReportingMonthId", "ReminderLogs");
		migrationBuilder.DeleteData("EmailTemplates", "Id", 8);
		migrationBuilder.DeleteData("SystemConstants", "Id", 7);
		migrationBuilder.DeleteData("SystemConstants", "Id", 8);
		migrationBuilder.AlterColumn<int>("ReportingMonthId", "ReminderLogs", "int", oldClrType: typeof(int), unicode: null, maxLength: null, rowVersion: false, schema: null, nullable: false, defaultValue: 0, defaultValueSql: null, computedColumnSql: null, oldType: "int", oldUnicode: null, oldMaxLength: null, oldRowVersion: false, oldNullable: true);
		migrationBuilder.AddForeignKey("FK_ReminderLogs_ReportingMonths_ReportingMonthId", "ReminderLogs", "ReportingMonthId", "ReportingMonths", null, null, "Id", ReferentialAction.NoAction, ReferentialAction.Cascade);
	}
