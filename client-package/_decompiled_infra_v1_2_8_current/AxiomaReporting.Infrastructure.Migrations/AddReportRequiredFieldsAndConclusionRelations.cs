...
[Migration("20260412164437_AddReportRequiredFieldsAndConclusionRelations")]
public class AddReportRequiredFieldsAndConclusionRelations : Migration
{
	protected override void Up(MigrationBuilder migrationBuilder)
	{
		migrationBuilder.InsertData("SystemConstants", new string[7] { "Id", "CreatedAt", "Description", "Key", "UpdatedAt", "UpdatedBy", "Value" }, new object[7]
		{
			...
			"Developer-level required report fields. Applies to new validation from the point the value is changed.",
			"RequiredReportFields",
			null,
			null,
			"AllocationId,DistrictId,LocalityId,FrameworkId,EducationalProgramId,DomainId,Subject1Id,MeetingDate,MeetingDuration"
		});
		migrationBuilder.CreateIndex("IX_ReportRows_ConclusionFrameworkId", "ReportRows", "ConclusionFrameworkId");
		migrationBuilder.CreateIndex("IX_ReportRows_ConclusionLocationId", "ReportRows", "ConclusionLocationId");
		migrationBuilder.AddForeignKey("FK_ReportRows_Frameworks_ConclusionFrameworkId", "ReportRows", "ConclusionFrameworkId", "Frameworks", null, null, "Id");
		migrationBuilder.AddForeignKey("FK_ReportRows_LocalityDistrictNational_ConclusionLocationId", "ReportRows", "ConclusionLocationId", "LocalityDistrictNationals", null, null, "Id");
	}

	protected override void Down(MigrationBuilder migrationBuilder)
	{
		migrationBuilder.DropForeignKey("FK_ReportRows_Frameworks_ConclusionFrameworkId", "ReportRows");
		migrationBuilder.DropForeignKey("FK_ReportRows_LocalityDistrictNational_ConclusionLocationId", "ReportRows");
		migrationBuilder.DropIndex("IX_ReportRows_ConclusionFrameworkId", "ReportRows");
		migrationBuilder.DropIndex("IX_ReportRows_ConclusionLocationId", "ReportRows");
		migrationBuilder.DeleteData("SystemConstants", "Id", 6);
	}
