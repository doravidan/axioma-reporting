...
[Migration("20260423093119_AddReportTypeAndProjectPrograms")]
public class AddReportTypeAndProjectPrograms : Migration
{
	protected override void Up(MigrationBuilder migrationBuilder)
	{
		migrationBuilder.AddColumn<int>("ReportTypeId", "ReportRows", "int", null, null, rowVersion: false, null, nullable: true);
		migrationBuilder.CreateTable("ProjectPrograms", (ColumnsBuilder table) => new
		{
			ProjectId = table.Column<int>("int"),
			ProgramId = table.Column<int>("int")
		}, null, table =>
		{
			table.PrimaryKey("PK_ProjectPrograms", x => new { x.ProjectId, x.ProgramId });
			table.ForeignKey("FK_ProjectPrograms_Programs_ProgramId", x => x.ProgramId, "Programs", "Id", null, ReferentialAction.NoAction, ReferentialAction.Restrict);
			table.ForeignKey("FK_ProjectPrograms_Projects_ProjectId", x => x.ProjectId, "Projects", "Id", null, ReferentialAction.NoAction, ReferentialAction.Cascade);
		});
		migrationBuilder.CreateTable("ReportTypes", delegate(ColumnsBuilder table)
		{
			...
			return new
			{
				...
				CreatedAt = createdAt,
				UpdatedAt = updatedAt,
				Description = table.Column<string>("nvarchar(500)", null, maxLength),
		...
		{
			{
				...
				true,
				"קובץ דיווח מרוכז נקלט בהצלחה",
				"BatchImportSuccessUploader",
				null
			},
			{
				10,
				...
				new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
				true,
				"שגיאות בקובץ דיווח מרוכז",
				"BatchImportErrors",
				null
			}
		});
		migrationBuilder.InsertData("ReportTypes", new string[5] { "Id", "CreatedAt", "Description", "IsActive", "UpdatedAt" }, new object[2, 5]
		{
			{
				1,
				new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
		...
		migrationBuilder.CreateIndex("IX_ReportRows_ReportTypeId", "ReportRows", "ReportTypeId");
		migrationBuilder.CreateIndex("IX_ProjectPrograms_ProgramId", "ProjectPrograms", "ProgramId");
		migrationBuilder.AddForeignKey("FK_ReportRows_ReportTypes_ReportTypeId", "ReportRows", "ReportTypeId", "ReportTypes", null, null, "Id");
	}

	protected override void Down(MigrationBuilder migrationBuilder)
	{
		migrationBuilder.DropForeignKey("FK_ReportRows_ReportTypes_ReportTypeId", "ReportRows");
		migrationBuilder.DropTable("ProjectPrograms");
		migrationBuilder.DropTable("ReportTypes");
		migrationBuilder.DropIndex("IX_ReportRows_ReportTypeId", "ReportRows");
		migrationBuilder.DeleteData("EmailTemplates", "Id", 9);
		migrationBuilder.DeleteData("EmailTemplates", "Id", 10);
		migrationBuilder.DropColumn("ReportTypeId", "ReportRows");
	}
