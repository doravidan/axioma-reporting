...
[Migration("20260430110451_AddHebrewDescriptionsToRolesAndStatuses")]
public class AddHebrewDescriptionsToRolesAndStatuses : Migration
{
	protected override void Up(MigrationBuilder migrationBuilder)
	{
		migrationBuilder.DeleteData("TermsOfUseAcceptances", "Id", 1);
		int? maxLength = 200;
		migrationBuilder.AddColumn<string>("DescriptionHebrew", "UserStatuses", "nvarchar(200)", null, maxLength, rowVersion: false, null, nullable: true);
		maxLength = 200;
		migrationBuilder.AddColumn<string>("DescriptionHebrew", "UserRoles", "nvarchar(200)", null, maxLength, rowVersion: false, null, nullable: true);
		migrationBuilder.UpdateData("TermsOfUseVersions", "Id", 1, "BodyHtml", "<p>ברוכים הבאים למערכת דיווח הפעילות החודשית של סייט אנד סאונד.</p><p>השימוש במערכת מותנה בהסכמה לתנאי השימוש הבאים. אנא קראו אותם בעיון לפני האישור.</p><p>1. השימוש במערכת מיועד לעובדים מורשים בלבד, לצורך דיווח פעילות חודשית בלבד. אין להעביר את פרטי הכניסה לאדם אחר ואין להשתמש במערכת בשם משתמש שאינו שלך.</p><p>2. כל הנתונים המוזנים במערכת מהווים דיווח רשמי. עליך לוודא שכל המידע המוזן נכון, מדויק ומשקף את הפעילות שבוצעה בפועל. דיווח כוזב מהווה הפרה של נהלי הארגון.</p><p>3. הארגון רשאי לבצע ביקורת על הדיווחים בכל עת. דיווחים אשר אושרו ננעלים לעריכה ולא ניתן יהיה לשנותם ללא אישור מנהל.</p><p>4. המערכת שומרת יומן ביקורת של כל הפעולות. הגישה למידע מותנית בהרשאות ובהתאם לתפקיד המוגדר במערכת.</p><p>5. הסיסמה שלך אישית וסודית. יש להחליפה כל 90 יום ולא לחזור על 5 הסיסמאות האחרונות. לאחר 3 ניסיונות כניסה כושלים החשבון יינעל אוטומטית.</p><p>גרסה זו של תנאי השימוש מהווה גרסת ביניים — הגרסה המחייבת תפורסם על ידי מנהל המערכת דרך מסך 'תנאי שימוש' תחת תפריט הניהול.</p>");
		migrationBuilder.UpdateData("UserRoles", "Id", 1, "DescriptionHebrew", "מנהל מערכת");
		migrationBuilder.UpdateData("UserRoles", "Id", 2, "DescriptionHebrew", "מנהל פרויקט");
		migrationBuilder.UpdateData("UserRoles", "Id", 3, "DescriptionHebrew", "רכז פרויקט");
		migrationBuilder.UpdateData("UserRoles", "Id", 4, "DescriptionHebrew", "מפקח-צפייה");
		migrationBuilder.UpdateData("UserRoles", "Id", 5, "DescriptionHebrew", "מפקח-אישור");
		migrationBuilder.UpdateData("UserRoles", "Id", 6, "DescriptionHebrew", "עובד");
		migrationBuilder.UpdateData("UserStatuses", "Id", 1, "DescriptionHebrew", "פעיל");
		migrationBuilder.UpdateData("UserStatuses", "Id", 2, "DescriptionHebrew", "לא פעיל");
		migrationBuilder.UpdateData("UserStatuses", "Id", 3, "DescriptionHebrew", "נעול");
		migrationBuilder.UpdateData("Users", "Id", 1, "PasswordHash", "$2a$12$4MIlxeD2MhS0aLHvy9Gx5.on9xw87chJAN76m8ifdsBb7FvNuMw36");
	}

	protected override void Down(MigrationBuilder migrationBuilder)
	{
		migrationBuilder.DropColumn("DescriptionHebrew", "UserStatuses");
		migrationBuilder.DropColumn("DescriptionHebrew", "UserRoles");
		...
		migrationBuilder.UpdateData("TermsOfUseVersions", "Id", 1, "BodyHtml", "תנאי שימוש — יסופקו על ידי הלקוח");
		migrationBuilder.UpdateData("Users", "Id", 1, "PasswordHash", "$2a$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewdGADNUvDdAfY2.");
	}

	protected override void BuildTargetModel(ModelBuilder modelBuilder)
	{
		modelBuilder.HasAnnotation("ProductVersion", "8.0.26").HasAnnotation("Relational:MaxIdentifierLength", 128);
		...
		modelBuilder.Entity("AxiomaReporting.Core.Entities.TermsOfUseVersion", delegate(EntityTypeBuilder b)
		{
			...
			{
				Id = 1,
				BodyHtml = "<p>?????? ????? ?????? ????? ??????? ??????? ?? ????&amp;????? ?????.</p><p>?????? ?????? ????? ?????? ????? ?????? ?????. ??? ???? ???? ????? ???? ??????.</p><p>1. ?????? ?????? ????? ??????? ?????? ????, ????? ????? ?????? ?????? ????. ??? ?????? ?? ???? ?????? ???? ??? ???? ?????? ?????? ??? ????? ????? ???.</p><p>2. ?? ??????? ??????? ?????? ?????? ????? ????. ???? ????? ??? ????? ????? ????, ????? ????? ?? ??????? ?????? ?????. ????? ???? ????? ???? ?? ???? ??????.</p><p>3. ?????? ???? ???? ?????? ?? ???????? ??? ??. ??????? ??? ????? ?????? ?????? ??? ???? ???? ?????? ??? ????? ????.</p><p>4. ?????? ????? ???? ?????? ?? ?? ???????. ????? ????? ?????? ??????? ?????? ?????? ?????? ??????.</p><p>5. ?????? ??? ????? ??????. ?? ??????? ?? 90 ??? ??? ????? ?? 5 ???????? ????????. ???? 3 ???????? ????? ?????? ?????? ????? ????????.</p><p>???? ?? ?? ???? ?????? ????? ???? ?????? — ????? ??????? ?????? ?? ??? ???? ?????? ??? ??? '???? ?????' ??? ????? ??????.</p>",
		...
		modelBuilder.Entity("AxiomaReporting.Core.Entities.UserRole", delegate(EntityTypeBuilder b)
		{
			b.Property<int>("Id").HasColumnType("int");
			b.Property<string>("Description").HasMaxLength(500).HasColumnType("nvarchar(500)");
			b.Property<string>("DescriptionHebrew").HasMaxLength(200).HasColumnType("nvarchar(200)");
			b.Property<string>("Name").IsRequired().HasMaxLength(100)
				.HasColumnType("nvarchar(100)");
			b.HasKey("Id");
