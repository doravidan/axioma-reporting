...
[Migration("20260423101845_AddTermsAuditNotificationLogsAndConcurrency")]
public class AddTermsAuditNotificationLogsAndConcurrency : Migration
{
	protected override void Up(MigrationBuilder migrationBuilder)
	{
		object defaultValue = new byte[0];
		migrationBuilder.AddColumn<byte[]>("RowVersion", "Users", "rowversion", null, null, rowVersion: true, null, nullable: false, defaultValue);
		defaultValue = new byte[0];
		migrationBuilder.AddColumn<byte[]>("RowVersion", "Reports", "rowversion", null, null, rowVersion: true, null, nullable: false, defaultValue);
		defaultValue = new byte[0];
		migrationBuilder.AddColumn<byte[]>("RowVersion", "ReportRows", "rowversion", null, null, rowVersion: true, null, nullable: false, defaultValue);
		defaultValue = new byte[0];
		migrationBuilder.AddColumn<byte[]>("RowVersion", "Allocations", "rowversion", null, null, rowVersion: true, null, nullable: false, defaultValue);
		migrationBuilder.CreateTable("AuditLogs", delegate(ColumnsBuilder table)
		{
			OperationBuilder<AddColumnOperation> id3 = table.Column<long>("bigint").Annotation("SqlServer:Identity", "1, 1");
			OperationBuilder<AddColumnOperation> timestamp = table.Column<DateTime>("datetime2", null, null, rowVersion: false, null, nullable: false, null, "GETUTCDATE()");
			OperationBuilder<AddColumnOperation> actorUserId = table.Column<int>("int", null, null, rowVersion: false, null, nullable: true);
			int? maxLength3 = 100;
			OperationBuilder<AddColumnOperation> action = table.Column<string>("nvarchar(100)", null, maxLength3);
			maxLength3 = 100;
			OperationBuilder<AddColumnOperation> entityType = table.Column<string>("nvarchar(100)", null, maxLength3);
			maxLength3 = 100;
			OperationBuilder<AddColumnOperation> entityId = table.Column<string>("nvarchar(100)", null, maxLength3, rowVersion: false, null, nullable: true);
			OperationBuilder<AddColumnOperation> before = table.Column<string>("nvarchar(max)", null, null, rowVersion: false, null, nullable: true);
			OperationBuilder<AddColumnOperation> after = table.Column<string>("nvarchar(max)", null, null, rowVersion: false, null, nullable: true);
			maxLength3 = 64;
			OperationBuilder<AddColumnOperation> ipAddress = table.Column<string>("nvarchar(64)", null, maxLength3, rowVersion: false, null, nullable: true);
			maxLength3 = 500;
			OperationBuilder<AddColumnOperation> userAgent = table.Column<string>("nvarchar(500)", null, maxLength3, rowVersion: false, null, nullable: true);
			maxLength3 = 1000;
			return new
			{
				Id = id3,
				...
				IpAddress = ipAddress,
				UserAgent = userAgent,
				Notes = table.Column<string>("nvarchar(1000)", null, maxLength3, rowVersion: false, null, nullable: true)
			};
		}, null, table =>
		{
			table.PrimaryKey("PK_AuditLogs", x => x.Id);
			table.ForeignKey("FK_AuditLogs_Users_ActorUserId", x => x.ActorUserId, "Users", "Id");
		});
		migrationBuilder.CreateTable("NotificationLogs", delegate(ColumnsBuilder table)
		{
			OperationBuilder<AddColumnOperation> id2 = table.Column<int>("int").Annotation("SqlServer:Identity", "1, 1");
			int? maxLength2 = 50;
			OperationBuilder<AddColumnOperation> notificationType = table.Column<string>("nvarchar(50)", null, maxLength2);
			maxLength2 = 100;
			OperationBuilder<AddColumnOperation> templateType = table.Column<string>("nvarchar(100)", null, maxLength2);
			OperationBuilder<AddColumnOperation> recipientUserId = table.Column<int>("int", null, null, rowVersion: false, null, nullable: true);
			maxLength2 = 500;
			OperationBuilder<AddColumnOperation> recipientEmail = table.Column<string>("nvarchar(500)", null, maxLength2);
			OperationBuilder<AddColumnOperation> relatedReportId = table.Column<int>("int", null, null, rowVersion: false, null, nullable: true);
			OperationBuilder<AddColumnOperation> relatedReportingMonthId = table.Column<int>("int", null, null, rowVersion: false, null, nullable: true);
			maxLength2 = 500;
			OperationBuilder<AddColumnOperation> subject = table.Column<string>("nvarchar(500)", null, maxLength2);
			OperationBuilder<AddColumnOperation> body = table.Column<string>("nvarchar(max)");
			maxLength2 = 20;
			OperationBuilder<AddColumnOperation> status = table.Column<string>("nvarchar(20)", null, maxLength2, rowVersion: false, null, nullable: false, "Pending");
			OperationBuilder<AddColumnOperation> attemptCount = table.Column<int>("int", null, null, rowVersion: false, null, nullable: false, 0);
			OperationBuilder<AddColumnOperation> lastAttemptAt = table.Column<DateTime>("datetime2", null, null, rowVersion: false, null, nullable: true);
			...
			return new
			{
				...
				RelatedReportingMonthId = relatedReportingMonthId,
				Subject = subject,
				Body = body,
				Status = status,
				...
				FailureReason = table.Column<string>("nvarchar(2000)", null, maxLength2, rowVersion: false, null, nullable: true),
				CreatedAt = table.Column<DateTime>("datetime2", null, null, rowVersion: false, null, nullable: false, null, "GETUTCDATE()")
			};
		}, null, table =>
		{
			table.PrimaryKey("PK_NotificationLogs", x => x.Id);
			table.ForeignKey("FK_NotificationLogs_ReportingMonths_RelatedReportingMonthId", x => x.RelatedReportingMonthId, "ReportingMonths", "Id");
			table.ForeignKey("FK_NotificationLogs_Reports_RelatedReportId", x => x.RelatedReportId, "Reports", "Id");
			table.ForeignKey("FK_NotificationLogs_Users_RecipientUserId", x => x.RecipientUserId, "Users", "Id");
		});
		migrationBuilder.CreateTable("TermsOfUseVersions", (ColumnsBuilder table) => new
		{
			Id = table.Column<int>("int").Annotation("SqlServer:Identity", "1, 1"),
			VersionNumber = table.Column<int>("int"),
			BodyHtml = table.Column<string>("nvarchar(max)"),
			EffectiveFrom = table.Column<DateTime>("datetime2"),
			PublishedByUserId = table.Column<int>("int"),
			CreatedAt = table.Column<DateTime>("datetime2", null, null, rowVersion: false, null, nullable: false, null, "GETUTCDATE()"),
		...
		}, null, table =>
		{
			...
			table.ForeignKey("FK_TermsOfUseVersions_Users_PublishedByUserId", x => x.PublishedByUserId, "Users", "Id", null, ReferentialAction.NoAction, ReferentialAction.Restrict);
		});
		migrationBuilder.CreateTable("TermsOfUseAcceptances", delegate(ColumnsBuilder table)
		{
			...
			OperationBuilder<AddColumnOperation> versionId = table.Column<int>("int");
			OperationBuilder<AddColumnOperation> acceptedAt = table.Column<DateTime>("datetime2");
			int? maxLength = 64;
			return new
			{
				Id = id,
				...
				IpAddress = table.Column<string>("nvarchar(64)", null, maxLength, rowVersion: false, null, nullable: true)
			};
		}, null, table =>
		{
			table.PrimaryKey("PK_TermsOfUseAcceptances", x => x.Id);
			table.ForeignKey("FK_TermsOfUseAcceptances_TermsOfUseVersions_VersionId", x => x.VersionId, "TermsOfUseVersions", "Id", null, ReferentialAction.NoAction, ReferentialAction.Restrict);
			table.ForeignKey("FK_TermsOfUseAcceptances_Users_UserId", x => x.UserId, "Users", "Id", null, ReferentialAction.NoAction, ReferentialAction.Restrict);
		});
		migrationBuilder.InsertData("TermsOfUseVersions", new string[7] { "Id", "BodyHtml", "CreatedAt", "EffectiveFrom", "PublishedByUserId", "UpdatedAt", "VersionNumber" }, new object[7]
		{
			1,
			"תנאי שימוש — יסופקו על ידי הלקוח",
			new DateTime(2026, 4, 23, 0, 0, 0, 0, DateTimeKind.Utc),
			new DateTime(2026, 4, 23, 0, 0, 0, 0, DateTimeKind.Utc),
			1,
			null,
			1
		});
		migrationBuilder.InsertData("TermsOfUseAcceptances", new string[5] { "Id", "AcceptedAt", "IpAddress", "UserId", "VersionId" }, new object[5]
		{
			1,
			new DateTime(2026, 4, 23, 0, 0, 0, 0, DateTimeKind.Utc),
			null,
		...
		migrationBuilder.CreateIndex("IX_AuditLogs_Action_Timestamp", "AuditLogs", new string[2] { "Action", "Timestamp" });
		migrationBuilder.CreateIndex("IX_AuditLogs_ActorUserId_Timestamp", "AuditLogs", new string[2] { "ActorUserId", "Timestamp" });
		...
		migrationBuilder.CreateIndex("IX_NotificationLogs_RecipientUserId_CreatedAt", "NotificationLogs", new string[2] { "RecipientUserId", "CreatedAt" });
		migrationBuilder.CreateIndex("IX_NotificationLogs_RelatedReportId", "NotificationLogs", "RelatedReportId");
		migrationBuilder.CreateIndex("IX_NotificationLogs_RelatedReportingMonthId", "NotificationLogs", "RelatedReportingMonthId");
		migrationBuilder.CreateIndex("IX_NotificationLogs_Status_NextRetryAt", "NotificationLogs", new string[2] { "Status", "NextRetryAt" });
		migrationBuilder.CreateIndex("IX_NotificationLogs_TemplateType_CreatedAt", "NotificationLogs", new string[2] { "TemplateType", "CreatedAt" });
		migrationBuilder.CreateIndex("IX_TermsOfUseAcceptances_UserId_VersionId", "TermsOfUseAcceptances", new string[2] { "UserId", "VersionId" }, null, unique: true);
		migrationBuilder.CreateIndex("IX_TermsOfUseAcceptances_VersionId", "TermsOfUseAcceptances", "VersionId");
		migrationBuilder.CreateIndex("IX_TermsOfUseVersion_VersionNumber", "TermsOfUseVersions", "VersionNumber", null, unique: true);
		migrationBuilder.CreateIndex("IX_TermsOfUseVersions_PublishedByUserId", "TermsOfUseVersions", "PublishedByUserId");
	}
	...
	protected override void Down(MigrationBuilder migrationBuilder)
	{
		...
		migrationBuilder.DropTable("TermsOfUseAcceptances");
		migrationBuilder.DropTable("TermsOfUseVersions");
		migrationBuilder.DropColumn("RowVersion", "Users");
		migrationBuilder.DropColumn("RowVersion", "Reports");
		migrationBuilder.DropColumn("RowVersion", "ReportRows");
		migrationBuilder.DropColumn("RowVersion", "Allocations");
	}
	...
	protected override void BuildTargetModel(ModelBuilder modelBuilder)
	{
		...
		modelBuilder.Entity("AxiomaReporting.Core.Entities.AuditLog", delegate(EntityTypeBuilder b)
		{
			...
			b.HasKey("Id");
			b.HasIndex("Timestamp").HasDatabaseName("IX_AuditLogs_Timestamp");
			b.HasIndex("Action", "Timestamp").HasDatabaseName("IX_AuditLogs_Action_Timestamp");
			b.HasIndex("ActorUserId", "Timestamp").HasDatabaseName("IX_AuditLogs_ActorUserId_Timestamp");
			b.HasIndex("EntityType", "EntityId").HasDatabaseName("IX_AuditLogs_EntityType_EntityId");
		...
		modelBuilder.Entity("AxiomaReporting.Core.Entities.NotificationLog", delegate(EntityTypeBuilder b)
		{
			b.Property<int>("Id").ValueGeneratedOnAdd().HasColumnType("int");
			b.Property<int>("Id").UseIdentityColumn(1L);
			b.Property<int>("AttemptCount").ValueGeneratedOnAdd().HasColumnType("int")
				.HasDefaultValue(0);
			b.Property<string>("Body").IsRequired().HasColumnType("nvarchar(max)");
			b.Property<DateTime>("CreatedAt").ValueGeneratedOnAdd().HasColumnType("datetime2")
				.HasDefaultValueSql("GETUTCDATE()");
			...
			b.Property<string>("NotificationType").IsRequired().HasMaxLength(50)
				.HasColumnType("nvarchar(50)");
			b.Property<string>("RecipientEmail").IsRequired().HasMaxLength(500)
				.HasColumnType("nvarchar(500)");
			b.Property<int?>("RecipientUserId").HasColumnType("int");
			b.Property<int?>("RelatedReportId").HasColumnType("int");
			b.Property<int?>("RelatedReportingMonthId").HasColumnType("int");
			...
			b.HasIndex("RecipientUserId", "CreatedAt").HasDatabaseName("IX_NotificationLogs_RecipientUserId_CreatedAt");
			b.HasIndex("Status", "NextRetryAt").HasDatabaseName("IX_NotificationLogs_Status_NextRetryAt");
			b.HasIndex("TemplateType", "CreatedAt").HasDatabaseName("IX_NotificationLogs_TemplateType_CreatedAt");
		...
		modelBuilder.Entity("AxiomaReporting.Core.Entities.ProjectProgram", delegate(EntityTypeBuilder b)
		{
			b.Property<int>("ProjectId").HasColumnType("int");
			b.Property<int>("ProgramId").HasColumnType("int");
		...
		modelBuilder.Entity("AxiomaReporting.Core.Entities.ReportRow", delegate(EntityTypeBuilder b)
		{
			...
			b.Property<int?>("ReportTypeId").HasColumnType("int");
			b.Property<byte[]>("RowVersion").IsConcurrencyToken().IsRequired()
				.ValueGeneratedOnAddOrUpdate()
				.HasColumnType("rowversion");
		...
		modelBuilder.Entity("AxiomaReporting.Core.Entities.ReportType", delegate(EntityTypeBuilder b)
		{
			b.Property<int>("Id").ValueGeneratedOnAdd().HasColumnType("int");
			b.Property<int>("Id").UseIdentityColumn(1L);
			b.Property<DateTime>("CreatedAt").ValueGeneratedOnAdd().HasColumnType("datetime2")
		...
		modelBuilder.Entity("AxiomaReporting.Core.Entities.TermsOfUseAcceptance", delegate(EntityTypeBuilder b)
		{
			b.Property<int>("Id").ValueGeneratedOnAdd().HasColumnType("int");
			b.Property<int>("Id").UseIdentityColumn(1L);
			...
			b.Property<string>("IpAddress").HasMaxLength(64).HasColumnType("nvarchar(64)");
			b.Property<int>("UserId").HasColumnType("int");
			b.Property<int>("VersionId").HasColumnType("int");
			b.HasKey("Id");
			b.HasIndex("VersionId");
			b.HasIndex("UserId", "VersionId").IsUnique();
			b.ToTable("TermsOfUseAcceptances", (string?)null);
			b.HasData(new
			{
				Id = 1,
				AcceptedAt = new DateTime(2026, 4, 23, 0, 0, 0, 0, DateTimeKind.Utc),
				UserId = 1,
				VersionId = 1
			});
		});
		modelBuilder.Entity("AxiomaReporting.Core.Entities.TermsOfUseVersion", delegate(EntityTypeBuilder b)
		{
			b.Property<int>("Id").ValueGeneratedOnAdd().HasColumnType("int");
			b.Property<int>("Id").UseIdentityColumn(1L);
			b.Property<string>("BodyHtml").IsRequired().HasColumnType("nvarchar(max)");
			b.Property<DateTime>("CreatedAt").ValueGeneratedOnAdd().HasColumnType("datetime2")
				.HasDefaultValueSql("GETUTCDATE()");
			b.Property<DateTime>("EffectiveFrom").HasColumnType("datetime2");
			b.Property<int>("PublishedByUserId").HasColumnType("int");
			b.Property<DateTime?>("UpdatedAt").HasColumnType("datetime2");
			b.Property<int>("VersionNumber").HasColumnType("int");
			b.HasKey("Id");
			b.HasIndex("PublishedByUserId");
			b.HasIndex("VersionNumber").IsUnique().HasDatabaseName("IX_TermsOfUseVersion_VersionNumber");
		...
		modelBuilder.Entity("AxiomaReporting.Core.Entities.AuditLog", delegate(EntityTypeBuilder b)
		{
			b.HasOne("AxiomaReporting.Core.Entities.User", "ActorUser").WithMany().HasForeignKey("ActorUserId")
		...
		modelBuilder.Entity("AxiomaReporting.Core.Entities.NotificationLog", delegate(EntityTypeBuilder b)
		{
			b.HasOne("AxiomaReporting.Core.Entities.User", "RecipientUser").WithMany().HasForeignKey("RecipientUserId")
				.OnDelete(DeleteBehavior.NoAction);
			b.HasOne("AxiomaReporting.Core.Entities.Report", "RelatedReport").WithMany().HasForeignKey("RelatedReportId")
				.OnDelete(DeleteBehavior.NoAction);
			b.HasOne("AxiomaReporting.Core.Entities.ReportingMonth", "RelatedReportingMonth").WithMany().HasForeignKey("RelatedReportingMonthId")
				.OnDelete(DeleteBehavior.NoAction);
		...
		modelBuilder.Entity("AxiomaReporting.Core.Entities.ProjectProgram", delegate(EntityTypeBuilder b)
		{
			b.HasOne("AxiomaReporting.Core.Entities.Program", "Program").WithMany().HasForeignKey("ProgramId")
				.OnDelete(DeleteBehavior.Restrict)
				.IsRequired();
			b.HasOne("AxiomaReporting.Core.Entities.Project", "Project").WithMany("ProjectPrograms").HasForeignKey("ProjectId")
				.OnDelete(DeleteBehavior.Cascade)
				.IsRequired();
			b.Navigation("Program");
			b.Navigation("Project");
		...
		modelBuilder.Entity("AxiomaReporting.Core.Entities.ReportRow", delegate(EntityTypeBuilder b)
		{
			...
			b.HasOne("AxiomaReporting.Core.Entities.Framework", "ConclusionFramework").WithMany().HasForeignKey("ConclusionFrameworkId")
				.OnDelete(DeleteBehavior.NoAction)
				.HasConstraintName("FK_ReportRows_Frameworks_ConclusionFrameworkId");
			b.HasOne("AxiomaReporting.Core.Entities.LocalityDistrictNational", "ConclusionLocation").WithMany().HasForeignKey("ConclusionLocationId")
				.OnDelete(DeleteBehavior.NoAction)
			...
			b.HasOne("AxiomaReporting.Core.Entities.Report", "Report").WithMany("ReportRows").HasForeignKey("ReportId")
				.OnDelete(DeleteBehavior.Cascade)
				.IsRequired();
			b.HasOne("AxiomaReporting.Core.Entities.ReportType", "ReportType").WithMany().HasForeignKey("ReportTypeId")
				.OnDelete(DeleteBehavior.NoAction);
		...
		modelBuilder.Entity("AxiomaReporting.Core.Entities.TermsOfUseAcceptance", delegate(EntityTypeBuilder b)
		{
			b.HasOne("AxiomaReporting.Core.Entities.User", "User").WithMany().HasForeignKey("UserId")
				.OnDelete(DeleteBehavior.Restrict)
				.IsRequired();
			b.HasOne("AxiomaReporting.Core.Entities.TermsOfUseVersion", "Version").WithMany("Acceptances").HasForeignKey("VersionId")
				.OnDelete(DeleteBehavior.Restrict)
				.IsRequired();
			b.Navigation("User");
		...
		modelBuilder.Entity("AxiomaReporting.Core.Entities.TermsOfUseVersion", delegate(EntityTypeBuilder b)
		{
			b.HasOne("AxiomaReporting.Core.Entities.User", "PublishedByUser").WithMany().HasForeignKey("PublishedByUserId")
				.OnDelete(DeleteBehavior.Restrict)
				.IsRequired();
