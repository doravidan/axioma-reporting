...
[Migration("20260423102908_AddSiteLogoPathConstant")]
public class AddSiteLogoPathConstant : Migration
{
	protected override void Up(MigrationBuilder migrationBuilder)
	{
		migrationBuilder.InsertData("SystemConstants", new string[7] { "Id", "CreatedAt", "Description", "Key", "UpdatedAt", "UpdatedBy", "Value" }, new object[7]
		{
			...
			"נתיב הלוגו של המערכת (תמונה ב-wwwroot). ניתן להחלפה דרך מסך 'לוגו המערכת'.",
			"SiteLogoPath",
			null,
			null,
			"/images/logo.png"
	...
	{
		migrationBuilder.DeleteData("SystemConstants", "Id", 9);
	}
