...
public static class SeedData
{
	...
	{
		modelBuilder.Entity<ReportStatus>().HasData(new ReportStatus
		{
			Id = 1,
			Name = "Draft",
	...
	{
		DateTime createdAt = new DateTime(2026, 1, 1, 0, 0, 0, DateTimeKind.Utc);
		modelBuilder.Entity<SystemConstant>().HasData(new SystemConstant
		{
			Id = 1,
	...
	{
		DateTime dateTime = new DateTime(2026, 4, 23, 0, 0, 0, DateTimeKind.Utc);
		modelBuilder.Entity<TermsOfUseVersion>().HasData(new TermsOfUseVersion
		{
			Id = 1,
			VersionNumber = 1,
